    ...
    <div class="releaseProducts">
        ...
        <div class="cont">
            ...
            <div class="CommodityDetails">
                ...
                <vue-ueditor-wrap v-if="false" ref="ueditor"
                                  v-model="msg"
                                  :destroy="false"
...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            /*提交发布*/
            submit(){
                let {goodsNo,name,SalesPrice,title,option,CommodityType,CommodityBrand,CommodityLabel,fileList,msg}=this,
                    list=[];
                fileList.map(item=>{
                ...
                if(!goodsNo||!name||!SalesPrice||!title||!option||!CommodityType||CommodityLabel.length<=0||list.length<=0||!msg){
                    this.$message({
                        message: "请完善商品基本信息",
                        type: 'error'
                    });
