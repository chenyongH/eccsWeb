    ...
    <div class="pcRight">
        <div class="pcBox">
            ...
            <div class="bottom">
                ...
                <!--<div class="li">
                    <span>我的产品</span>
                    <span>已上线 <b class="skyBlue">0</b></span>
                    <span>审核中 <b>0</b></span>
                    <span>审核拒绝 <b class="red">0</b></span>
                    <span>已下线 <b>0</b></span>
                </div>-->
        ...
        <div v-if="type==1||type==2" class="pcBox">
            ...
            <ul class="bottom">
                <li v-for="item in data.chanceList">
        ...
        <div v-if="type==0||type==2" class="pcBox">
            ...
            <ul class="bottom">
                <li v-for="item in data.goodsList">
                ...
                <!--<li>
                    <span>合肥市乔润商贸有限公司</span>
                    <span>发布需求</span>
                    <span class="skyBlue">采购手提布袋</span>
...
<script>
    ...
    export default{
        ...
        mounted(){
            ...
            /*this.statusCode=this.$route.query.status;*/
            this.type=this.$store.state.personal.Admission;
            this.statusCode=this.$store.state.personal.Status;
