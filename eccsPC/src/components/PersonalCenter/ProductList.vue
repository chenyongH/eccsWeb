        ...
        <el-table
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <div @click.stop="handleClick(scope.row)" style="cursor: pointer" v-if="scope.row.goodsImage" class="picBox">
            ...
            <el-table-column
                    ...
                    label="操作">
                <template slot-scope="scope">
                    <a v-if="type==1" @click.stop="lowerFrame(scope.row.goodsId)" style="white-space: nowrap">下架</a>
                    <a v-if="type==3" @click.stop="setBO(scope.row.goodsId)" style="white-space: nowrap">设置</a>
                    <!--<a v-if="type==1" @click="setRI(item.id,item.chanceName)" style="white-space: nowrap;margin-left: 10px;" >报名查询</a>-->
                </template>
            </el-table-column>
        </el-table>
        <!--<table>
            ...
            <tr class="table-header">
                <th>商品名称</th>
                <th>当前价格</th>
                &lt;!&ndash;<th>商品类型</th>&ndash;&gt;
                &lt;!&ndash;<th>商品分类</th>&ndash;&gt;
                &lt;!&ndash;<th>商品品牌</th>&ndash;&gt;
                <th>发布时间</th>
                &lt;!&ndash;<th>结束时间</th>
                <th>阶段</th>&ndash;&gt;
                &lt;!&ndash;<th style="white-space: nowrap" v-if="type==1||type==3">操作</th>&ndash;&gt;
            </tr>
            <tr class="table-body"
                :key="idx"
                ...
                &lt;!&ndash;商品名称&ndash;&gt;
                <td class="tdTwo">
                    <img :src="imgUrl+item.goodsImage.imgList" alt="">
                    <span class="span1">{{item.goodsName}}</span>
                </td>
                &lt;!&ndash;当前价格&ndash;&gt;
                <td>{{item.salePrice}}</td>
                &lt;!&ndash;商品类型&ndash;&gt;
                &lt;!&ndash;<td>{{item.beginDate}}</td>&ndash;&gt;
                &lt;!&ndash;商品分类&ndash;&gt;
                &lt;!&ndash;<td>{{item.chanceName}}{{item.chanceInfo}}</td>&ndash;&gt;
                &lt;!&ndash;商品品牌&ndash;&gt;
                &lt;!&ndash;<td>{{item.endDate}}</td>&ndash;&gt;
                &lt;!&ndash;发布时间&ndash;&gt;
                <td>{{item.saleTime}}</td>
                &lt;!&ndash;操作&ndash;&gt;
                &lt;!&ndash;<td v-if="type==1||type==3">
                    <a v-if="type==1" @click="lowerFrame(item.id)" style="white-space: nowrap" >下架</a>
                    <a v-if="type==3" @click="setBO(item.id)" style="white-space: nowrap" >设置</a>
                    <a v-if="type==1" @click="setRI(item.id,item.chanceName)" style="white-space: nowrap;margin-left: 10px;" >报名查询</a>
                </td>&ndash;&gt;
            </tr>
