    ...
    <div @click="handleClick" class="supplierCont">
        <div class="content">
            ...
            <ul id="filters" class="detail">
                ...
                <li>
                    <div class="left">
                        ...
                        <a v-if="idxType<5" @click="filter('typeId',type.id)"
                           :key="idxType" v-for="(type,idxType) in types.slice(0,5)">{{type.name}}</a>
                    </div>
                        ...
                        <el-dropdown>
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item @click.native="filter('typeId',typeMore.id)"
                                                  :key="idx"
                                                  v-if="idx>5" v-for="(typeMore,idx) in types.slice(5,types.length)">{{typeMore.name}}
                                </el-dropdown-item>
                            </el-dropdown-menu>
                        </el-dropdown>
                    </div>
                ...
                <li v-if="specs" :key="idx" v-for="(spec,idx) in specs">
                    <div class="left">
                        ...
                        <a :key="specValue.id"
                           v-for="(specValue,moreId) in spec.specValues.slice(0,5)"
                           v-if="moreId<5"
                        ...
                        <el-dropdown>
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item v-if="spec.specValues.length>5"
                                                  ...
                                                  :key="more"
                                                  v-for="(values,more) in spec.specValues.slice(5,spec.specValues.length)">{{values.spec_alias}}
                                </el-dropdown-item>
                            </el-dropdown-menu>
                        </el-dropdown>
                    </div>
            ...
            <div v-if="brands" class="brand">
                ...
                <div class="right">
                    <div @mouseleave="mouseleave" @click.stop="filter('brandId',brand.id)"
                ...
                <div class="left">
                    ...
                    <div class="filter">
                        ...
                        <el-dropdown v-if="false">
                            <el-button>
                                显示顺序<i class="el-icon-arrow-down el-icon--right"></i>
                            </el-button>
                            <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown v-if="false">
                            <el-button>
                                VIP指数<i class="el-icon-arrow-down el-icon--right"></i>
                            </el-button>
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item>黄金糕</el-dropdown-item>
                                <el-dropdown-item>狮子头</el-dropdown-item>
                    ...
                    <div class="proBox">
                        ...
                        <div v-if="information.store" :key="idxInfo" v-for="(information,idxInfo) in companyInfor"
                             class="enterprise">
                            <div class="left">
                                ...
                                <div class="relationship">
                                    ...
                                    <i class=""><img :src="imgUrl+information.store.medalImg" alt=""></i>
                                    <i class=""><img :src="imgUrl+information.store.medalImg" alt=""></i>
                                </div>
                                <ul class="enterpriseGo">
                                    <li @click="navToCompany(information.store.id)"><i class="iconfont icon-photo"></i>企业产品
                                    </li>
                                    <li v-if="information.store.storeTel" @click="connect"><i class="iconfont icon-phonecall"></i>{{information.store.storeTel}}</li>
...
<script>
    ...
    export default {
        ...
        watch: {
            companyInfor: function(curVal,oldVal){
                if(curVal.length<=0){
        ...
        methods: {
            ...
            handleSearch(){
                ...
                this.noData='';/*清空数据*/
                /*清空状态选中*/
                /*$("#filters>li>.left>a").css({color: '#666', backgroundColor: '#fff'});*/
//                $("#filters>li>.left>a:first").css({color:'#fff',backgroundColor:'#17A6B5'});
...
//              console.log(e)
            ...
            filter(key, value, index, d){
                 ...
                 * */
                /*清空排序*/
                this.sortlist.timeSort = '0'; /*更新时间*/
                    this.sortlist.levelSort = ''; /*公司规模*/
                    this.state1 = '';
                    this.state2 = '';
                        /*筛选条件*/
                    ...
                    if(key == "specId"){
                        ...
                        this.server(url,api.portSupply,pa).then(res=>{
                            ...
                            $("#filters>li>.left>a").click(function () {
                                ...
                                $(this).siblings().css({color: '#666', backgroundColor: '#fff'});
                            })
                        })
                    }else{
                        this.query[key] = value;
...
//                console.log(d,params)
            ...
            handleSizeChange(val) {
                ...
                let pa = {
                    ...
                    url = this.supplyList;
                /*api.$http('http://220w3791j3.imwork.net:56300/open/api/goods/supplyList',pa)*/  //post请求，因为在api.js中只封装了post的方法
                this.server(url, api.portSupply, pa).then(res => {
                    if(res.code){
                        this.$message({
                            message: res.msg,
