	...
	export default {
		...
		data(){
			return {
				...
				hotschannelId:[],
				hotsStr:[],
				liNum:['li1','li2','li3','li4','li5','li6','li7','li8','li9','li10']
			}
		},
		methods:{
...
<style scoped>
	*{
	...
	.rankings .search .li1 span,.rankings .heat .li1 span{
	...
	.rankings .search .li2 span,.rankings .heat .li2 span{
	...
	.rankings .search .li3 span,.rankings .heat .li3 span{
