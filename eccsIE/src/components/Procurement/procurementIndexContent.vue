...
<style>
	...
	/*#procurementIndexContent .block .el-pager li{
	...
	#procurementIndexContent .block .el-pager li.active{
		border: 1px solid #17a6b5;
		color: #17a6b5;
	}*/
	/*#procurementIndexContent .block .el-pagination span:not([class*=suffix]){
		color: #b1b1b1;
	}*/
