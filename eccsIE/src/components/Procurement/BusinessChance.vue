            ...
            <div class="content_bottom">
                <div class="left">
                    <div class="filter">
                        ...
                        <label style="display:flex; display: -webkit-flex; display: -moz-box;display: -ms-flexbox; align-items: center">
                            <span style="white-space: nowrap;   margin-right:10px;">注册资本</span>
                            <el-input size="mini" v-model="state1" style="width: 100px;"></el-input> &nbsp;&nbsp;万-&nbsp;&nbsp;
                            <el-input size="mini" v-model="state2" style="width: 100px;"></el-input> &nbsp;&nbsp;万&nbsp;&nbsp;
                        </label>
                            <!-- <el-autocomplete
                                class="inline-input"
                                v-model="state1"
...
export default {
  ...
  watch: {
    ...
    TopProcurementSearch() {
      ...
      api
        ...
        // .then(() => {
        //   $(".detail li .left a").click(function() {
        //     //   alert(111)
        //     $(this).css({ color: "#fff", backgroundColor: "#17A6B5" });
        //     $(this)
        //       .siblings()
  ...
  methods: {
    ...
    filter(key, value, index, d) {
      ...
      $(event.target).css({ color: "#fff", backgroundColor: "#17A6B5" })
      $(event.target).parent().children().not(event.target).css({'background':'#ffffff','color':'#666666'});
      /*筛选条件*/
      let params = {
        ...this.query,
        pageNumber: this.currentPage,
