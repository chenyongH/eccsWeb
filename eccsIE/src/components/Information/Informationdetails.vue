                ...
                <el-carousel-item v-for="(banner,idx) in banners" :key="idx">
                  ...
                  <div v-else-if="banner.cmsBanner.type===2">
                      <div class="banner_imgBox" :style="{width:'100% !important',height:'100% !important'}">
                          <img :style="{width:'100% !important',height:'286px !important'}"  v-bind:src="imgUrl+banner.cmsBanner.picurl" alt="" @click="openNews(banner.cmsArticle.id,banner.cmsBanner.url,banner.cmsArticle.channelId)">
                      </div>
                   </div>
                  <div  v-else>                
