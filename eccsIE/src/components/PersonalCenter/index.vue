        ...
        <div class="pcBanner">
          <div id="pcSwiper" class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="../../assets/images/banners_1.png" alt=""></div>
                    <div class="swiper-slide"><img src="../../assets/images/banners_2.png" alt=""></div>
