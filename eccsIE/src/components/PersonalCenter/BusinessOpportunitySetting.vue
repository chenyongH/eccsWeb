<template>
    <div class="pcRight">
        ...
        <form action="">
            <div class="formBox"> <!--商机名称 businessName-->
                <div class="label" style="width:100%;">
                    <span class="labels">商机名称</span>
                    <el-input size="mini" style="width:82%;" v-model="businessName" class="input" type="text"></el-input>
                </div>
            ...
            <label class="label forEditor"><span class="labels">其他备注</span>
                <span class="editor">
                    <textarea v-model="others" name="Others" id="Others" cols="100" rows="10"></textarea>
                </span>
            </label>
    ...
    export default{
        ...
        mounted(){
            ...
            this.server(url,pa).then(res => {
                ...
                /*10资金担保*/
                this.businessName=res.data.chance.chanceName; /*商机名称*/
              /*商机别名*/
              this.noLoginChanceName= res.data.chance.noLoginChanceName;
                this.purchaseGoods=res.data.chance.buyGoods; /*采购商品*/
                this.type=res.data.chance.type; /*商机类别*/
                this.businessDescription=res.data.chance.chanceInfo; /*商机描述*/
                this.others=res.data.chance.remark; /*其他备注*/
                this.links=res.data.chance.linkMobile;/*联系方式*/
                this.name=res.data.chance.linkman;/*联系人*/
            })
        }
