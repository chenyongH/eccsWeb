        ...
        <table>
            ...
            <tr class="table-body" v-for='item in tableData'>
                ...
                <td v-if="type==1||type==3">
                    <a v-if="type==1" @click.stop="lowerFrame(item.id)" style="cursor:pointer;color: rgb(23, 166, 181);white-space: nowrap" >下架</a>
                    <a v-if="type==3" @click.stop="setBO(item.id)" style="cursor:pointer;color: rgb(23, 166, 181);white-space: nowrap" >设置</a>
                    <a v-if="type==1" @click.stop="setRI(item.id,item.chanceName)" style="cursor:pointer;color: rgb(23, 166, 181);white-space: nowrap;margin-left: 10px;" >报名查询</a>
                </td>
            </tr>
